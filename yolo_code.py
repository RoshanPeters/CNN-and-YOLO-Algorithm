...
net.setInput(blob)
outs = net.forward(output_layers)  # contains the information of the detected objects
...
# using non max supression incase the algorithm detects two or more classes for the same object
